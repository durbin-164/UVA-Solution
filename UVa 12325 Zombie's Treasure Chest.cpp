   ...
   // FI;
    ...
    while(test--)
    {
        ...
        if(s1>sqrt(n))
        {
            ...
            {
                LL x = (n-i*s1)/s2; // x poriman jaiga kali asa so x/s2 ti s2 nite parbo
                LL xx = x*v2+i*v1; // i*s1 poriman s1 niscti
                //cout<<xx<<endl;
            ...
            {
                 LL x = (n-i*s2)/s1; // x poriman jaiga kali asa so x/s1 ti s1 nite parbo
                 LL xx = x*v1+i*v2;
                //cout<<xx<<endl;
